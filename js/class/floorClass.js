export default class Floor {
    ...
    constructor (floor,x,characterWidth,ctx) {
        ...
        this.floorsInitX = [-667/3+74+characterWidth/2,222-74-characterWidth/2,2*667/3-74-characterWidth/2,3*667/3-74-characterWidth/2,4*667/3-74-characterWidth/2]
        this.x = x
